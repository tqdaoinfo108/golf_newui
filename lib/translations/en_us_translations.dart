const Map<String, String> en = {
  ...
  'phone': 'Phone',
  'dashboard_credit_usage': 'Pay-per-use',
  'dashboard_member_plan_usage': 'Member plan usage',
  'dashboard_special_member': 'Special member',
  'save': 'Save',
  ...
  'cannot_select_4_consecutive_blocks':
      'Cannot select multiple consecutive blocks',
  ...
  'vip_member': 'Member Info',
  'owning': 'Owning',
  'cards': 'Cards',
  'transaction_history': 'Plan Purchase History',
  'buy_vip_member': 'Buy Plan',
  ...
  "usage": "Usage",
  "card_number": "Card Number (alphanumeric)",
  "card_number_invalid": "Please enter a valid 16-digit card number",
  "card_number_empty": "Please enter your card number",
  ...
  "cvv_invalid": "Please enter a 3-digit number (4 digits for AMEX)",
  "expired_date": "Expiration Date (MM / YY)",
  "expired_date_empty": "Please enter the expiration date",
  "expired_date_hint": "(e.g. 08 / 26)",
  "expired_date_placeholder": "MM / YY",
  "card_holder": "Cardholder Name (alphabetic)",
  "card_holder_empty": "Please enter the cardholder name",
