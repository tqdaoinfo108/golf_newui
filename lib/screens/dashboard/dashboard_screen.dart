...
class DashboardScreen extends GetView<DashboardController> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<DashboardController>(initState: (_state) {
      controller.page = 1;
                            ...
                            children: [
                              ...
                              Text(
                                  DateTime.now()
                                      ...
                                      .toStringFormatDate(),
                                  style: TextStyle(
                                      color: Colors.white70, fontSize: 12.0.sp))
                            ],
                          ),
                        ],
                      )
                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        DefaultTabController(
                          ...
                          child: TabBar(
                            indicatorColor: Color(0xFF0CA17C),
                            ...
                            tabs: [
                              ...
                              SizedBox(
                                height: 45.0.sp,
                                child: Tab(
                                    child: rowTabbar(theme,
                                        Icons.cancel_outlined, 'canceled'.tr)),
                              ),
                            ],
                          ),
                        )
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: (controller.isLoadingBookingHistory &&
                          ...
                          : controller.lstDateBooking.length == 0
                              ...
                              : NotificationListener<ScrollNotification>(
                                  ...
                                  child: ListView.builder(
                                    itemCount: controller.totalLoadedBooking <
                                            controller.totalBooking!
