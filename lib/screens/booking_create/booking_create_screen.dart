...
class BookingCreateScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetX<BookingCreateController>(builder: (controller) {
      return Scaffold(
        ...
        body: Container(
          ...
          children: [
            ...
            Padding(
              ...
              child: Obx(
                () => Stack(children: [
                  shopItemView(themeData, controller.shopSelected!,
                      onFavoriteChanged: (val) => controller
                          .changeFavorite(controller.shopSelected!.shopID)),
                  ...
                  Container(
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        children: [
                          /// Choose date
                          chooseDateBooking(context, themeData, controller,
                          ...
                          /// Choose machine
                          chooseSlotBooking(controller, context, themeData,
                              controller.lstSlot),
                          SizedBox(height: 10),
                          chooseBlockBooking(controller, context, themeData,
                              controller.lstBlock),
