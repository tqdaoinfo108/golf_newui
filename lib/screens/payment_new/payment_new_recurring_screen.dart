...
import 'payment_new_recurring_controller.dart';

class PaymentRecurringScreen extends GetView<PaymentRecurringController> {
  PaymentRecurringScreen({Key? key}) : super(key: key);
