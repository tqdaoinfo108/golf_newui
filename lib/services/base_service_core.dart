...
abstract class ApiClient {
  ...
  Future<String?> login(
      @Header("Authorization") String auth, @Body() Map<String, dynamic> body);
  ...
  Future<String?> getSlot(
      @Header("Authorization") String auth, @Query("ShopID") int? shopID);
  ...
  @Headers(headerDefault)
  Future<String?> getHistoryBookingDetail(@Header("Authorization") String auth,
      @Path("userID") int? userID, @Path("bookID") int? bookID);
  ...
  Future<String?> uploadAvatar(
      @Header("Authorization") String auth, @Part() File file);
  ...
  @Headers(headerDefault)
  Future<String?> getProfile(@Header("Authorization") String auth,
      @Query('UserID') int? userID, @Query('UUSerID') String? uUSerID);
  ...
  @Headers(headerDefault)
  Future<String?> updateBookingStatus(@Header("Authorization") String auth,
      @Path("bookID") int? bookId, @Body() Map<String, dynamic> body);
  ...
  Future<String?> clearNotification(
      @Header("Authorization") String auth, @Query("userID") int? userID);
  ...
  Future<String?> getConfigByKey(
      @Header("Authorization") String auth, @Query("keyConfig") String key);
  ...
  Future<String?> cardMpiCheckResult(
      @Header("Authorization") String auth, @Query("orderID") String orderID);
}
